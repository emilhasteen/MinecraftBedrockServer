...
Update_Scripts() {
  ...
  curl -H "Accept-Encoding: identity" -L -o start.sh https://raw.githubusercontent.com/emilhasteen/MinecraftBedrockServer/master/start.sh
  chmod +x start.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o stop.sh https://raw.githubusercontent.com/emilhasteen/MinecraftBedrockServer/master/stop.sh
  chmod +x stop.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o restart.sh https://raw.githubusercontent.com/emilhasteen/MinecraftBedrockServer/master/restart.sh
  chmod +x restart.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o fixpermissions.sh https://raw.githubusercontent.com/emilhasteen/MinecraftBedrockServer/master/fixpermissions.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o update.sh https://raw.githubusercontent.com/emilhasteen/MinecraftBedrockServer/master/update.sh
  chmod +x update.sh
}
...
Update_Service() {
  ...
  sudo curl -H "Accept-Encoding: identity" -L -o /etc/systemd/system/$ServerName.service https://raw.githubusercontent.com/emilhasteen/MinecraftBedrockServer/master/minecraftbe.service
...
Check_Architecture () {
  ...
  if [[ "$CPUArch" == *"aarch"* || "$CPUArch" == *"arm"* ]]; then
    ...
    curl -H "Accept-Encoding: identity" -L -o depends.zip https://raw.githubusercontent.com/emilhasteen/MinecraftBedrockServer/master/depends.zip
    unzip depends.zip
    sudo mkdir /lib64
